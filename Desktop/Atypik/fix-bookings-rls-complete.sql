-- Complete RLS fix for bookings table - Run this in your Supabase SQL editor
...
-- 8. Test the RLS policies (optional - run this to verify)
-- This will show you if the policies are working correctly
SELECT 
