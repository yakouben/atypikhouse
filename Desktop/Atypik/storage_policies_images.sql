-- =====================================================
-- COMPLETE STORAGE SETUP FOR IMAGES BUCKET
-- =====================================================
-- Run this entire script in your Supabase SQL Editor
-- This will remove existing bucket/policies and recreate them

-- =====================================================
-- STEP 1: REMOVE EXISTING POLICIES AND BUCKET
-- =====================================================

-- Drop existing storage policies for images bucket
...
-- Drop existing storage policies for property-images bucket (if they exist)
...
-- If the bucket already exists, this will not cause an error
...
-- Policy 5: Allow authenticated users to list files in the bucket (for management)
